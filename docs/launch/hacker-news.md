...
Show HN: RawBridge — convert large RAW photo folders without huge ZIP downloads

RawBridge is an open-source CLI and local UI for converting large RAW photo folders from Dropbox, Google Drive, S3/R2, and local folders into optimized WebP/AVIF/JPEG assets.
