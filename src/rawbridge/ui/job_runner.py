...
from rawbridge.pipeline.failed_log import read_failed_log
from rawbridge.pipeline.jobs import new_job_id
from rawbridge.pipeline.manifest import Manifest
from rawbridge.ui.schemas import JobCreateRequest, JobEvent, JobStatus


class JobRunner:
    def __init__(self) -> None:
        self.executor = ThreadPoolExecutor(max_workers=1, thread_name_prefix="rawbridge-ui")
...
def _manifest_job(output_dir: Path, job_id: str) -> Any | None:
    manifest_path = output_dir / ".rawbridge_manifest.sqlite"
